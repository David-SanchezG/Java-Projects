...
import leopardoyvacas.*;
import javax.swing.JButton;


public class vistaloyove extends javax.swing.JFrame {

   public tableroloyove loyove=new tableroloyove();
...
loyove.accionpulsar(7,6);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vistaloyove.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            @Override
            public void run() {
                new vistaloyove().setVisible(true);
            }
        });
    }
